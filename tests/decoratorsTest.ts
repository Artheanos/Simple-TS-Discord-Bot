...
import { blacklist, ownerOnly, whitelist } from "../src/commands/decorators";
import config from 'config';

config.ownerId = 'THIS_IS_THE_OWNER_ID_1234'
...
describe('ownerOnly decorator tests', () => {
  ...
  test('ownerOnly should be inaccessible by not the owner', () => {
    ...
    fakeProps.message.author.id = 'THIS_IS_NOT_THE_OWNER_ID';
    new T().handleMessage(fakeProps);
